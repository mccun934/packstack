...
def initConfig(controllerObject):
    ...
    paramsList = [
                  ...
                  {"CMD_OPTION"      : "os-client-install",
                   ...
                   "NEED_CONFIRM"    : False,
                   "CONDITION"       : False },
                  {"CMD_OPTION"      : "os-api-install",
                   "USAGE"           : "Selects if packstack does or does not install a api server for all endpoints",
                   "PROMPT"          : "Selects if packstack does or does not install a api server for all endpoints",
                   "OPTION_LIST"     : ["y", "n"],
                   "VALIDATION_FUNC" : validate.validateOptions,
                   "DEFAULT_VALUE"   : "n",
                   "MASK_INPUT"      : False,
                   "LOOSE_VALIDATION": False,
                   "CONF_NAME"       : "CONFIG_API_INSTALL",
                   "USE_DEFAULT"     : False,
                   "NEED_CONFIRM"    : False,
                   "CONDITION"       : False },
                 ]
